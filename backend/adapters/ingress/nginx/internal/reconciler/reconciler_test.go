...
func TestApply_AddAndReload(t *testing.T) {
	...
	ig := model.Ingress{
		...
		MatchKind:    render.MatchKindDomain,
...
func TestApply_NginxTFails_RollsBack(t *testing.T) {
	...
	db.Create(&svc)
	ig := model.Ingress{EdgeServerID: edge.ID, MatchKind: render.MatchKindDomain, Domain: "x.com"}
	db.Create(&ig)
...
func TestApply_NginxTFails_MarksBrokenForPending(t *testing.T) {
	...
	pendingIg := model.Ingress{
		EdgeServerID: edge.ID, MatchKind: render.MatchKindDomain,
...
func TestApply_DryRun_DoesNotWrite(t *testing.T) {
	...
	db.Create(&svc)
	ig := model.Ingress{EdgeServerID: edge.ID, MatchKind: render.MatchKindDomain, Domain: "d.com"}
	db.Create(&ig)
...
func TestLoadDesired_RawUpstream(t *testing.T) {
	...
	edge := model.Server{Name: "e"}
	db.Create(&edge)
	ig := model.Ingress{EdgeServerID: edge.ID, MatchKind: render.MatchKindPath, Domain: "shared.com"}
	db.Create(&ig)
	rt := model.IngressRoute{
	...
	got, err := LoadDesired(db, &edge, "", render.DefaultProfile())
	if err != nil {
		t.Fatalf("load: %v", err)
	}
...
func TestLoadDesired_ServiceMissingPortErrors(t *testing.T) {
	...
	if _, err := LoadDesired(db, &edge, "", render.DefaultProfile()); err == nil {
