...
func TestDiff_PureAdd(t *testing.T) {
	desired := []render.ConfigFile{{Path: "/x", Content: "hi"}}
...
func TestDiff_Update(t *testing.T) {
	desired := []render.ConfigFile{{Path: "/z", Content: "new"}}
...
func TestDiff_NoOp(t *testing.T) {
	desired := []render.ConfigFile{{Path: "/a", Content: "same"}}
